...
1. espaçame**Rota rápida para mudanças simples**
  - Reconhecer texto, cor, imagem, link, tamanho, nto e 
  - Fazer uma única alteração cirúrvisibilidade mesmo com erros de digitação.
  - Localizar o alvo de forma determinística e evitar IA quando a alteração puder ser comprovada diretamente.gica, validar o arquivo e criar um commit real.
