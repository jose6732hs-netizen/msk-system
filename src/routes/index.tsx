      ...
      <main className="flex-1 flex flex-col items-center p-5 relative overflow-visible">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center w-full min-w-0 pt-8 md:pt-16 gap-12 text-left relative z-20">
          ...
          >
            ...
            <motion.h1 variants={fadeInUp} className="text-3xl font-black tracking-tighter sm:text-6xl lg:text-7xl bg-gradient-to-b from-green-500 to-green-500/40 bg-clip-text text-transparent uppercase leading-[0.95] break-words text-center md:text-left py-2">
