// oi - MSK SISTEM ATUALIZADA - MODO MSK ATIVO (WEB & EXTENSION) - TELA DE BLOQUEIO E BRANDING ADMIN ATUALIZADOS - Super Admin: sempreteste552@gmail.com - EXTENSÃO ÚNICA E DOWNLOAD VERIFICADO 100% - ADMIN COM BOTÃO ATIVAR NAS EXTENSÕES E CARD DE CANAIS PROFISSIONAL - msk_sistem_licenciada.zip essa deve ser a ynica - CORREÇÃO 'OBJECT NOT FOUND' NO DOWNLOAD REALIZADA - TELA DE LICENÇA AGORA ABRE IN POPUP CENTRALIZADO - LOGO E BANNERS ATUALIZADOS - AJUSTE DE BOTÕES QUEBRADOS EM TABLETS REALIZADO - CRIPTOGRAFIA DE LICENÇA E ASSINATURA DE WEBHOOKS CONFIGURADAS (HMAC-SHA256) - configure aas licence incription pra todas chaves de api ou webbook funcionarem slplits etc2 - ASSINATURA DE DADOS ATIVADA (CMS & LICENSE) - VERIFICAÇÃO DE ASSINATURA HABILITADA - CHAVES DE CRIPTOGRAFIA GERADAS E INTEGRADAS NO BACKEND E WEBHOOKS - IMAGEM DO CARD DIÁRIO ATUALIZADA NO CARROSSEL DE PLANOS - CORREÇÃO DE BOTÕES TRANSBORDANDO E REDIRECIONAMENTO DE DOWNLOAD CORRIGIDO - CORREÇÃO DO DOWNLOAD NO PAINEL E SINCRONIZAÇÃO DE CANAIS DE EXTENSÃO - DOWNLOAD DE EXTENSÃO AGORA É LIVRE (SEM LOGIN) - CORREÇÃO DE ACESSO À ABA DE AFILIADOS E ROTAS DE PARCEIROS SINCRONIZADAS - FLUXO DE ATIVAÇÃO DE TOKENS ATUALIZADO: NOVOS TOKENS INICIAM COMO 'INACTIVE' - adicione uma seta nas ofertas caso cliente que voltar oferta porem deve permanecer o  carrosel altomatico - os baineres devem aarecer 100% sem cortes em todos dispositivos devem se adaptar ao formato e evitar nao deve ter cortes - deixe apenas as imagens que mandei pir ultimo em afuliado e as setas de mudar de bainer atrapalha a leitura melhore isso - TEXTO DA PÁGINA INICIAL AMARELO ATUALIZADO
      ...
      <main className="flex-1 flex flex-col items-center p-5 relative overflow-visible">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center w-full min-w-0 pt-8 md:pt-16 gap-12 text-left relative z-20">
          ...
          >
            ...
            <motion.h1 variants={fadeInUp} className="text-3xl font-black tracking-tighter sm:text-6xl lg:text-7xl bg-gradient-to-b from-orange-500 to-orange-500/40 bg-clip-text text-transparent uppercase leading-[0.95] break-words text-center md:text-left py-2">
