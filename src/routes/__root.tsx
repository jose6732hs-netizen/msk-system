...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    scripts: [
      {
        children: `!function(f,b,e,v,n,t,s){if(f.fbq)return;n=f.fbq=function(){n.callMethod?n.callMethod.apply(n,arguments):n.queue.push(arguments)};if(!f._fbq)f._fbq=n;n.push=n;n.loaded=!0;n.version='2.0';n.queue=[];t=b.createElement(e);t.async=!0;t.src=v;s=b.getElementsByTagName(e)[0];s.parentNode.insertBefore(t,s)}(window,document,'script','https://connect.facebook.net/en_US/fbevents.js');fbq('init','1473326273695938');fbq('track','PageView');`,
      },
    ],
  }),
...
function MobileNavigation() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-[120] w-full max-w-full lg:hidden">
      ...
      <nav
        className="grid w-full grid-cols-5 items-stretch gap-0 border-t border-white/10 bg-background/90 px-1 pt-1.5 backdrop-blur-2xl"
