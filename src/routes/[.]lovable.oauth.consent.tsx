  ...
  return (
    <main className="flex min-h-screen items-center justify-center p-4">
      <div className="w-full max-w-md rounded-[2.5rem] border border-white/10 bg-[#0F0F0F] p-10 shadow-2xl relative overflow-hidden">
        ...
        {error && (
          <div className="mb-6 p-4 rounded-xl bg-red-500/10 border border-red-500/20 text-xs text-red-500 font-bold uppercase">
            {error}
          </div>
        )}
        ...
        <div className="grid gap-3">
          <button 
            disabled={busy} 
            onClick={() => decide(true)}
            className="h-12 w-full rounded-2xl bg-primary text-sm font-black uppercase tracking-widest text-white shadow-lg shadow-primary/20 hover:bg-primary/90 transition-all disabled:opacity-50"
          >
          ...
          <button 
            ...
            className="h-12 w-full rounded-2xl bg-white/5 border border-white/10 text-sm font-black uppercase tracking-widest text-white hover:bg-white/10 transition-all disabled:opacity-50"
          >
            Cancelar
          </button>
        </div>
