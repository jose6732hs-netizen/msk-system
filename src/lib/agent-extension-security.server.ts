...
const OFFICIAL_BUILDS = new Map<string, { version: string; integrity_root: string }>([
  ...
  [
    "msk-agent-3.14.13-resilient-requests-13cb7c59eab25281",
    { version: "3.14.13", integrity_root: "13cb7c59eab2528177a2741fef0e43186653e8e0562863181b60bdcf6c6a7670" },
  ],
  [
  ...
  [
    "msk-agent-3.14.16-stable-ai-transport-4a6d915c9e2e8f81",
    { version: "3.14.16", integrity_root: "4a6d915c9e2e8f819dabfce956c66d9bdae3e6ce2641967a5f71846fed530c3f" },
  ],
  [
  ...
  [
    "msk-agent-3.14.19-large-prompt-recovery-21305c64754d5fae",
    { version: "3.14.19", integrity_root: "21305c64754d5faea6bc89f4eb39550aff4cdebc80d213227a766e400b7a411e" },
  ],
]);
