  ...
  return (
    <>
      <a
        ...
        className="group fixed bottom-[calc(5.75rem+env(safe-area-inset-bottom,0px))] right-3 z-[105] lg:bottom-8 lg:right-8"
      >
        <span className="pointer-events-none absolute inset-0 animate-ping rounded-full bg-[#25D366]/30" />
        <span
          className="relative grid h-14 w-14 place-items-center rounded-full border border-white/25 transition-transform duration-300 ease-out group-hover:-translate-y-1 group-active:translate-y-0 lg:h-16 lg:w-16"
          style={{
        ...
        >
          ...
          />
          <svg viewBox="0 0 32 32" className="relative h-7 w-7 drop-shadow-[0_2px_2px_rgba(0,0,0,0.35)] lg:h-8 lg:w-8" fill="#fff" aria-hidden="true">
