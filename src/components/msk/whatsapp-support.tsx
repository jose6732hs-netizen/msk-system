 ...
 * Só aparece quando o Super Admin configura o número na aba de Suporte.
 */
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <svg viewBox="0 0 32 32" className="relative h-7 w-7 drop-shadow-[0_2px_2px_rgba(0,0,0,0.35)] md:h-8 md:w-8" fill="#fff">
